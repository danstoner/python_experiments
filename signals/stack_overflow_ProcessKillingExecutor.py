"""From https://codereview.stackexchange.com/questions/142828/python-executer-that-kills-processes-after-a-timeout
"""
...
if __name__ == "__main__":
    ...
    generator = executor.map(some_task, [1, 1, 2, 2, 3, 3, 8, 8], timeout=1,
