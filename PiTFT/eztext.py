### code from http://www.pygame.org/project-EzText-920-.html
### and https://github.com/ffavela/eztext
...
class Input:
    ...
    def __init__(self, **options):
        ...
        self.options = Config(options, ['x', '0'], ['y', '0'], ['font','pygame.font.Font("/usr/share/fonts/truetype/freefont/FreeSans.ttf", 25)'],
...
#            self.options.font = pygame.freetype.get_default_font()
